...
{
    public class ScreenPad : IScreenPad
    {
        ...
        IBaseVerticalShooterGame game;

        public bool XTYPE;

        #endregion

        public ScreenPad(IBaseVerticalShooterGame game, Texture2D pad, Texture2D thumb, Texture2D fire,
        ...
        public ScreenPad(IBaseVerticalShooterGame game, ContentManager contentManager)
        {
            this.game = game;

            var localContent = new ContentManager(contentManager.ServiceProvider);
            localContent.RootDirectory = "Content";
            padTexture = localContent.Load<Texture2D>("ThumbBase");
            thumbTexture = localContent.Load<Texture2D>("ThumbStick");
            abxyTexture = localContent.Load<Texture2D>("ABXY_buttons");
        ...
        private void PlaceControls(bool xType)
        {
            ...
            yOffest = GameSettings.Instance.DeviceScreenSize.Y - padTexture.Height - 30;
            ...
            ButtonX = new Vector2(700f, 392f);
            xButtonCollision = new BoundingSphere(new Vector3(new Vector2(ButtonX.X + 42f, ButtonX.Y + 42f), 0), 42);

            ButtonY = new Vector2(700f, 272f);
            yButtonCollision = new BoundingSphere(new Vector3(new Vector2(ButtonY.X + 42f, ButtonY.Y + 42f), 0), 42f);

            ButtonA = new Vector2(700f, 152f);
            aButtonCollision = new BoundingSphere(new Vector3(new Vector2(ButtonA.X + 42f, ButtonA.Y + 42), 0), 42);
        ...
        public bool LeftStickIsIdle
        {
            get { return Math.Abs(LeftStick.X) + Math.Abs(LeftStick.Y) == 0; }
        }
    }
}
