...
namespace BaseVerticalShooter
{
    ...
    public class BaseResolver
    {
        ...
        {
            Resolver.Instance.Register<ILineProcessor, LineProcessor>();
            Resolver.Instance.Register<IFunctionExecutor, FunctionExecutor>();
            Resolver.Instance.Register<IReviewHelper, ReviewHelper>();
        }
